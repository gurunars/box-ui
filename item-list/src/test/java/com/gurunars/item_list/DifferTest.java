...
public class DifferTest {
    ...
    public void itemCreate_shouldProduceSingleItemListWithCreation() throws Exception {
        assertEquals(
                Collections.singletonList(
                        new ChangeCreate<>(new AnimalItem(7, 1), 6, 6)),
                differ.apply(
                        Arrays.asList(
                                new AnimalItem(1, 1),
                                new AnimalItem(2, 1),
    ...
    public void itemDelete_shouldProduceSingleItemListWithRemoval() throws Exception {
        assertEquals(
                Collections.singletonList(
                        new ChangeDelete<>(new AnimalItem(3, 1), 2, 2)),
                differ.apply(
                        Arrays.asList(
                                new AnimalItem(1, 1),
                                new AnimalItem(2, 1),
    ...
    public void moveUp_shouldProduceSingleItemList() throws Exception {
        assertEquals(
                Collections.singletonList(
                        new ChangeMove<>(new AnimalItem(5, 1), 4, 1)),
                differ.apply(
                        Arrays.asList(
                                new AnimalItem(1, 1),
                                new AnimalItem(2, 1),
    ...
    public void moveDown_shouldProduceSingleItemList() throws Exception {
        assertEquals(
                Collections.singletonList(
                        new ChangeMove<>(new AnimalItem(2, 1), 1, 4)),
                differ.apply(
                        Arrays.asList(
                                new AnimalItem(1, 1),
                                new AnimalItem(2, 1),
    ...
    public void simpleDiff_isCorrect() throws Exception {
        ...
        assertEquals(
                Arrays.asList(
                        new ChangeDelete<>(new AnimalItem(5, 1), 4, 4),
                        new ChangeDelete<>(new AnimalItem(2, 1), 1, 1),
                        new ChangeCreate<>(new AnimalItem(7, 2), 0, 0),
